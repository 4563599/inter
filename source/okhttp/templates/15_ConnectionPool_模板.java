...
public class ConnectionPool {
    ...
    public synchronized void put(RealConnection connection) {
        ...
        //     cleanupThread.setDaemon(true);  // 守护线程，不阻止JVM退出
        //     cleanupThread.start();
        // }
    ...
    private synchronized long cleanup(long now) {
        // TODO: 步骤1 - 遍历所有连接，找出最长空闲的
        // int inUseConnectionCount = 0;    // 使用中的连接数
        // int idleConnectionCount = 0;     // 空闲连接数
        // RealConnection longestIdleConnection = null;  // 最长空闲的连接
        // long longestIdleDurationNs = Long.MIN_VALUE;  // 最长空闲时间
        //
        ...
        //     // 所有连接都在使用中，等待keepAliveDuration后再检查
